            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 justify-center flex-wrap">
                ...
                <Button
                  ...
                  disabled={!viewOrder.invoice_url}
                  onClick={() => {
                    if (!viewOrder.invoice_url) {
                      toast({ title: "Generate share link first", description: "Click 'Share Link' to create a shareable invoice URL", variant: "destructive" });
                      return;
                    }
                    const companyName = companySettings?.name || "Our Company";
                    const message = `${companyName}\n\nYour parcel from "${companyName}" has been picked up & processed.\n\nFor tracking, click here: ${viewOrder.invoice_url}`;
